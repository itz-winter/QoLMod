...
4. (Recommended) Install ModMenu to adjust settings in-game.
...
- Trade Refresh - press bound key to cycle villager trades.
- Tree Chopper - hold an axe while swinging to fell trees.
