...
public class TpaCommand {
    ...
    private static int executeAccept(CommandContext<ServerCommandSource> ctx, String senderName) {
        ...
        if (senderName != null) {
            ServerPlayerEntity senderPlayer = ctx.getSource().getMinecraftServer().getPlayerManager().getPlayer(senderName);
        ...
        ServerPlayerEntity sender = ctx.getSource().getMinecraftServer().getPlayerManager().getPlayer(request.senderId);
        if (sender == null) {
        ...
        if (request.tpaHere) {
            target.teleport((net.minecraft.server.world.ServerWorld) sender.world,
            ...
            sender.teleport((net.minecraft.server.world.ServerWorld) target.world,
