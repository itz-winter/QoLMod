 ...
 * Adapted for 1.20.1 (pre-component system, uses Item.getFoodComponent()).
 */
public class HungerDisplayRenderer {
    ...
    public static void render(DrawContext context, float tickDelta) {
        ...
        // Render exhaustion indicator
        if (config.hungerDisplayShowExhaustion && exhaustion > 0) {
            renderExhaustionOverlay(context, screenWidth, screenHeight, exhaustion, config);
        }
