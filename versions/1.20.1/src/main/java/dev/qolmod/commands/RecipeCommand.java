...
public class RecipeCommand {
    ...
    private static int executeRecipe(CommandContext<ServerCommandSource> ctx) {
        ...
        // Find recipes that produce this item — in 1.20.1, getResult() takes no arguments
    ...
    /**
     * Gets the result of a recipe. In 1.20.1 yarn mappings, the method is getOutput(DynamicRegistryManager).
     */
