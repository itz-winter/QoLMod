...
public class WarpManager {
    ...
    public void load(MinecraftServer server) {
        warpsFile = server.getSavePath(LevelResource.ROOT).resolve("qolmod_warps.json");
        warps.clear();
    ...
    public void setWarp(String name, ResourceKey<World> dimension, BlockPos pos, float yaw, float pitch) {
    ...
    public static class WarpData {
        ...
        public WarpData(String name, ResourceKey<World> dimension, BlockPos pos, float yaw, float pitch) {
            this.name = name;
