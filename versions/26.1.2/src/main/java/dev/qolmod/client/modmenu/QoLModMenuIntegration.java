...
public class QoLModMenuIntegration implements ModMenuApi {
    ...
    public static class QoLConfigScreen extends Screen {
        ...
        protected QoLConfigScreen(Screen parent) {
            super(Component.literal("QoL Mod — Settings"));
            this.parent = parent;
        }
        ...
        private void rebuildWidgets() {
            ...
            addDrawableChild(Button.builder(
                    Component.literal("Hunger Display Colours..."),
            ...
            addDrawableChild(Button.builder(
                    ...
                    btn -> { config.save(); Minecraft.getInstance().setScreen(parent); }
        ...
        public void render(GuiGraphics ctx, int mx, int my, float delta) {
            ...
            ctx.drawCenteredTextWithShadow(this.textRenderer,
                    Component.literal("§6§lQoL Mod — Settings"), this.width / 2, 12, 0xFFFFFF);
        ...
        private void addLabel(int cx, int y, String text) {
            addDrawableChild(new net.minecraft.client.gui.widget.TextWidget(
                    ...
                    Component.literal(text), this.textRenderer));
        }
        ...
        private void addToggle(int cx, int y, String label, String key) {
            ...
            addDrawableChild(Button.builder(
                    Component.literal(label + ": " + state),
                    btn -> {
                        boolean nv = !config.getBool(key);
                        config.put(key, nv);
                        btn.setMessage(Component.literal(label + ": " + (nv ? "§aON" : "§cOFF")));
                    }
    ...
    public static class HungerDisplaySettingsScreen extends Screen {
        ...
        protected HungerDisplaySettingsScreen(Screen parent) {
            super(Component.literal("Hunger Display — Colours"));
            this.parent = parent;
        }
        ...
        protected void init() {
            ...
            satColorField = new TextFieldWidget(this.textRenderer, cx - fw / 2, y, fw, 18,
                    Component.literal("Saturation Colour"));
            ...
            exhaustColorField = new TextFieldWidget(this.textRenderer, cx - fw / 2, y, fw, 18,
                    Component.literal("Exhaustion Colour"));
            ...
            // Buttons
            int bw = 90;
            addDrawableChild(Button.builder(Component.literal("Save & Back"),
                    btn -> saveAndClose()
        ...
        public void render(GuiGraphics ctx, int mx, int my, float delta) {
            this.renderBackground(ctx, mx, my, delta);
            ctx.drawCenteredTextWithShadow(this.textRenderer,
                    Component.literal("§6§lHunger Display — Colours"), this.width / 2, 16, 0xFFFFFF);
            super.render(ctx, mx, my, delta);
        ...
        private void renderSwatch(GuiGraphics ctx, TextFieldWidget field, String hex) {
            try {
